...
contract TrotelCoinIntermediateNFTV2 is ERC721, Ownable {
    ...
    function mint(address to) public {
        require(isEligibleForExpertNFT(to), "Not eligible for Intermediate NFT");
    ...
    function checkUserProgress(address user) public view returns (bool eligible) {
        eligible = isEligibleForNFT(user);
    }
